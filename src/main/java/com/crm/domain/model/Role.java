...
public class Role implements Serializable{
	 ...
	 * public Role() { super(); }
	 * 
	 * public Role(Long id, String nome) { super(); this.id = id; this.nome = nome;
	 * }
	 * 
	 ...
	 * 
	 * @Column(name="role_id") public Long getId() { return id; } public void
	 ...
	 * @JsonIgnore
	 * 
	 * @ManyToMany(mappedBy="roles") public List<Usuario> getUsuarios() { return
	 * usuarios; }
	 * 
	 ...
	 * 
	 * @Override public String toString() { return "Role [id=" + id + ", nome=" +
	 * nome + "]"; }
	 */
